...
warp-setup:
	$(call AS_ROOT,$(RUN_SAFE) --name setup-warp -- "WARP_PROXY_PORT=$(WARP_PROXY_PORT)" "SQLITE_BUSY_TIMEOUT_MS=$(SQLITE_BUSY_TIMEOUT_MS)" "SQLITE_RETRY_ATTEMPTS=$(SQLITE_RETRY_ATTEMPTS)" bash $(WARP_SCRIPT))

warp-setup-direct:
	$(call AS_ROOT,env WARP_PROXY_PORT="$(WARP_PROXY_PORT)" SQLITE_BUSY_TIMEOUT_MS="$(SQLITE_BUSY_TIMEOUT_MS)" SQLITE_RETRY_ATTEMPTS="$(SQLITE_RETRY_ATTEMPTS)" bash $(WARP_SCRIPT))

...
```bash
sudo bash ./ops/vpn-node/setup_warp.sh
```

## Документация

- [docs/SERVER.md](/home/begugla1/code/vpn/vpn-backend/docs/SERVER.md)
- [docs/PIPELINE.md](/home/begugla1/code/vpn/vpn-backend/docs/PIPELINE.md)
